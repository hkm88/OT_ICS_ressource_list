...
* [Sections:](#sections)
  ...
  + [ICS Blue Team](#ics-blue-team)
    ...
    - [ICS SOC](#ics-soc)
      * [ICS Rules](#ics-rules)
  + [ICS Radio-Frequency](#ics-radio-frequency)
    - [Zigbee](#zigbee)
...
| [SAFE Lab DFRWS Challenge](https://dfrws-challenge-safe-lab.webflow.io/) | Interactive website companion for the DFRWS 2023 ICS forensics challenge with detailed scenario context. |
...
| [COSMICENERGY OT Malware Analysis](https://cloud.google.com/blog/topics/threat-intelligence/cosmicenergy-ot-malware-russian-response/?hl=en) | Mandiant analysis of COSMICENERGY, a novel OT malware potentially linked to Russian emergency response exercises targeting IEC 60870-5-104 devices. |
| [JA4+ Fingerprint Database](https://ja4db.com/) | Community-maintained network fingerprint repository useful for identifying and fingerprinting ICS/OT network traffic. |
| [SANS State of ICS/OT Security 2025](https://drive.google.com/file/d/1_AUjyy5IJsDeA2-vqMoQXLR2yoEbca1U/view) | Annual SANS survey report on the state of ICS/OT cybersecurity practices and trends. |
| [Black Industry: IRGC-Linked Offensive OT Framework](https://lab52.io/blog/black-industry-irgc-linked-offensive-ot-framework/) | Lab52 report on an IRGC-linked offensive OT framework targeting industrial control systems. |
...
| [biero-el-corridor honepot detections nuclei template](https://github.com/biero-el-corridor/ICS_CPS_nuclei_template/tree/main/template/Honeypot_detection) | template to uwe with nuclei to detec defined honeypot (snap7 & Ethnernet/IP\_CIP base) |
...
| [Detection of critical infrastructure devices on the public Internet](https://repository.tudelft.nl/file/File_727d6d82-f372-4caf-91e4-a4af0258b0ee?preview=1) | TU Delft research paper on detecting critical infrastructure devices exposed on the public Internet. |
| [Nuclei template for CPS and honeypot detections (article)](https://medium.com/@biero-llagas/nuclei-template-for-cyber-physical-system-and-honeypot-detections-6cab308f2438) | Medium article explaining the approach and design of nuclei templates for detecting ICS honeypots and cyber-physical systems. |
...
| [Arabic Automation Courses Collection](https://fr.scribd.com/document/674116750/) | Curated list of important automation and PLC courses and resources (Arabic). |
...
| [PLC4X S7 Protocol Documentation](https://plc4x.incubator.apache.org/protocols/s7/index.html) | Apache PLC4X project documentation for the Siemens S7 protocol, useful for understanding S7 communication internals. |
| [OpenPLC DNP3 Outstation Reference](https://github.com/openplcproject/openplcproject.github.io/blob/master/reference/dnp3-outstation/index.md) | Reference documentation for configuring and using the DNP3 outstation feature in OpenPLC. |
| [BACnet Stack GitHub Organization](https://github.com/bacnet-stack) | GitHub organization hosting various open-source BACnet protocol stack implementations. |
| [c104 - IEC 60870-5-104 Python Library](https://pypi.org/project/c104/) | Python library for IEC 60870-5-104 protocol communication, useful for testing and simulating ICS environments. |
| [BACnet communication with PLC and SCADA - Pentotest](https://www.pentotest.com/blogs/bacnet-communication-with-plc-and-scada) | Article explaining BACnet protocol communication between PLCs and SCADA systems with practical examples. |
| [DALI Lighting Protocol](https://jared.geek.nz/2025/06/dali-lighting-protocol/) | Technical deep-dive into the DALI (Digital Addressable Lighting Interface) protocol used in building automation. |
...
| [BACnet MS/TP Capture Tool Documentation](https://github.com/stargieg/bacnet-stack/blob/master/demo/mstpcap/mstpcap.txt) | Documentation for the BACnet MS/TP packet capture tool from the bacnet-stack project. |
| [Siemens LOGO! Parameter VM Mapping](https://support.industry.siemens.com/cs/mdm/100782807?c=85315142923&lc=en-US) | Siemens support page for parameter VM mapping on LOGO! 0BA7 and later devices. |
...
| [Digital Bond S4 Conference CTF PCAP Files](https://www.netresec.com/?page=DigitalBond_S4) | ICS-focused packet captures from the Digital Bond S4 conference capture-the-flag events. |
...
| [Exploring URGENT/11 Vulnerabilitie](https://github.com/biero-el-corridor/OT_ICS_ressource_list/blob/main) | Exploring and Exploiting Programmable Logic Controllers with URGENT/11 Vulnerabilitie |
...
| [Fuzzing\_ICS\_protocols](https://1modm.github.io/Fuzzing_ICS_protocols.html) | Great article the express the aproach of the writer to fuzze BACNet and modbus protocol |
...
| [DEF CON 15 - Unraveling SCADA Protocols Using Sulley Fuzzer](https://www.youtube.com/watch?v=UUta_Ord8GI&ab_channel=DEFCONConference) | DEF CON 15 talk by Ganesh Devarajan on reverse engineering SCADA protocols using the Sulley fuzzing framework. |
| [Enhancing Suricata IDS for SCADA Network Security](https://www.researchgate.net/publication/317723884_Enhancing_Suricata_intrusion_detection_system_for_cyber_security_in_SCADA_networks) | Research paper on enhancing the Suricata intrusion detection system for improved cyber security monitoring in SCADA networks. |
| [ICS Honeypot System (CamouflageNet) Based on Attacker's Human Factors](https://www.sciencedirect.com/science/article/pii/S2351978915001766) | 2015 research paper on designing ICS honeypots that account for attacker human factors and behavior. |
...
| [OPC UA SDKs - Traeger](https://www.traeger.de/products/development/opcua) | Dedicated OPC UA development kits and SDKs for building OPC UA clients and servers. |
| [PROVIEW - Open Source Control System](https://www.bh-automation.com/Resources/For-automation-and-control-engineers/free-open-source-plc.html#top) | Free and open-source complete control system software for process automation and PLC-like functionality. |
| [RS485 Sniffer](https://jheyman.github.io/blog/pages/RS485Sniffer/) | Tutorial and project for building an RS485 bus sniffer, useful for monitoring Modbus RTU and other serial ICS protocols. |
...
| [EcoStruxure Control Expert V16.0 installation file](https://www.se.com/uk/en/download/document/EcoStruxureControlExpert_V16.0/) | Latest free trial version of Schneider Electric EcoStruxure Control Expert for Modicon PLC programming. |
...
| [Lab setup of a Schenider electric ecosystem](https://medium.com/@biero-llagas/lab-setup-notice-non-uniformity-for-authentication-system-security-modicon-emulator-on-1a0b743cb386) | Lab setup |
...
| [Wireshark for Modbus RTU - ABB Technical Note](https://library.e.abb.com/public/053acd5e47a04d938e15537a5d253e74/Technical_Note_179_WiresharkForModbusRTU.pdf) | ABB technical note on using Wireshark to capture and analyze Modbus RTU serial traffic. |
| [BACnet/MS-TP Lab Guide](https://www.waketech.edu/sites/default/files/program-page-files/BAT-221%20Lab%2007%20BACnet-MSTP%20Lab.pdf) | Hands-on lab guide for setting up and working with BACnet MS/TP protocol in a building automation training environment. |
...
| [mySCADA myPRO Manager RCE Vulnerabilities](https://catalyst.prodaft.com/public/report/myscada-mypro-manager-and-runtime-rce-vulnerabilities/overview) | Prodaft analysis of critical remote code execution vulnerabilities found in mySCADA myPRO Manager and Runtime. |
| [Kaspersky report on first-stage implants in industrial environments](https://industrialcyber.co/news/kaspersky-reports-on-first-stage-implants-used-for-persistent-remote-access-across-indus) | Kaspersky ICS CERT report on first-stage implants used for persistent remote access across industrial organizations. |
...
| [PLC Handbook - AutomationDirect](https://cdn.automationdirect.com/static/eBooks/PLC%20Handbook.pdf) | Free comprehensive PLC handbook covering fundamentals, programming, and applications from AutomationDirect. |
| [Scanning Highly Sensitive Networks](https://drive.google.com/file/d/1_22MtEjveuv-Apl2ghQrfR5TaSnSPJAG/view) | Guide on techniques and considerations for scanning highly sensitive OT/ICS networks without disrupting operations. |
...
| [MrPLC Community Forum](https://mrplc.com/) | Community forum for PLC programmers and automation professionals covering multiple PLC brands and protocols. |
...
| [OFRAK - Binary Analysis and Modification](https://ofrak.com/) | Open-source tool for unpacking, modifying, and repacking firmware binaries, useful for ICS firmware analysis. |
...
| [FCC ID Search](https://fccid.io/) | Search engine for FCC ID database, useful for identifying wireless modules and radio equipment in ICS/IoT devices. |
...
| Title | Description |
| --- | --- |
| [ICP DAS WP-8821-CE7 Manuals](https://www.manualslib.com/products/Icp-Das-Usa-Wp-8821-Ce7-11704276.html) | User manuals and documentation for the ICP DAS WP-8821-CE7 PAC (Programmable Automation Controller). |
...
| [ENISA Online Training - Network Forensics](https://www.enisa.europa.eu/topics/training-and-exercises/trainings-for-cybersecurity-specialists/online-training-material) | ENISA free online training material for cybersecurity specialists, including network forensics exercises applicable to ICS environments. |
| [ISA/IEC 62443 Training Course (IC32M)](https://www.isa.org/products/using-the-isa-iec-62443-standards-to-secure-your-i) | ISA official training course on using the ISA/IEC 62443 standards to secure industrial automation and control systems. |
...
| [French Business Continuity Plan Guide (PCA)](https://www.economie.gouv.fr/files/hfds-guide-pca-plan-continuite-activite-_sgdsn.pdf) | Official French government guide for business continuity planning (Plan de Continuité d'Activité) from SGDSN. |
...
| [NIS 2 Directive Articles](https://www.nis-2-directive.com/NIS_2_Directive_Articles_(Proposal_16.12.2020).html) | Full text of the NIS 2 Directive articles, the updated EU framework for cybersecurity of critical infrastructure including OT/ICS systems. |
...
| [ETHOS - Emerging Threat Open Sharing](https://www.ethos-org.io/) | Open-source platform for sharing emerging threat information across the OT/ICS security community in near real-time. |
| [Enabling Collective Defense with ETHOS - Claroty](https://claroty.com/blog/enabling-collective-defense-ethos) | Claroty article explaining the ETHOS initiative and how it enables collective defense against OT cyber threats. |
| [Scadalliance](https://scadalliance.com/fr) | Alliance of SCADA/ICS cybersecurity stakeholders fostering collaboration and knowledge sharing in the OT security space. |
...
| [FortiDeceptor Datasheet](https://www.fortinet.com/content/dam/fortinet/assets/data-sheets/FortiDeceptor.pdf) | Fortinet FortiDeceptor deception technology datasheet, applicable to OT/ICS environments for detecting lateral movement and reconnaissance. |
| [Nozomi Networks Platform Overview PDF](https://assets-global.website-files.com/645a4534705010e2cb244f50/65b121e2e08c0ab6e6b0278d_Nozomi-Networks-Platform-Overview.pdf) | Detailed overview document of the Nozomi Networks OT/IoT visibility and security platform. |
...
| [OTORIO](https://www.otorio.com/) | OT security solutions and exposure management vendor specializing in risk assessment and attack surface management for industrial environments. |
| [OTbase - OT Asset Management](https://otbase.com/) | OT asset management software for discovering, tracking and managing operational technology assets across industrial networks. |
...
| [Network Traffic Analysis with Malcolm - INL PDF](https://inl.gov/content/uploads/2023/07/Network-Traffic-Analysis-with-Malcolm.pdf) | Idaho National Laboratory presentation on using Malcolm for ICS network traffic analysis and threat detection. |
...
| Title | Description |
| --- | --- |
| [BLE Security Research Paper](http://www.diva-portal.org/smash/get/diva2:1464511/FULLTEXT01.pdf) | Academic paper on Bluetooth Low Energy security analysis relevant to ICS/IoT wireless communications. |
| [Quick Introduction to gatttool for BLE Data Access](https://cxiao.net/posts/2015-12-13-gatttool/) | Practical tutorial on using gatttool to interact with Bluetooth Low Energy devices, applicable to IoT/ICS device testing. |

## Zigbee

| Title | Description |
| --- | --- |
| [IoT Security - Zigbee Protocol 101 - Payatu](https://payatu.com/masterclass/iot-security-part-5-zigbee-protocol-101/) | Introduction to Zigbee protocol security fundamentals in the context of IoT security assessment. |
| [Don't Kick Over the Beehive: Attacks and Security Analysis on Zigbee (CCS 2022)](https://personal.utdallas.edu/~shao/papers/wang_ccs22.pdf) | Academic paper from CCS 2022 analyzing attacks and security weaknesses in the Zigbee protocol. |
| [Zigbee Cluster Library Specification](https://zigbeealliance.org/wp-content/uploads/2019/12/07-5123-06-zigbee-cluster-library-specification.pdf) | Official Zigbee Cluster Library specification document for understanding Zigbee application-layer communication. |
| [Zigbee Protocol Security Assessment - Kaspersky Securelist](https://securelist.com/zigbee-protocol-security-assessment/118373/) | Kaspersky's in-depth security assessment of the Zigbee protocol covering vulnerabilities and attack vectors. |
| [Sniffing Philips Hue Zigbee Traffic with Wireshark](https://blog.smartere.dk/2019/03/sniffing-philips-hue-zigbee-traffic-with-wireshark/) | Practical guide on capturing and analyzing Zigbee traffic from Philips Hue smart lighting using Wireshark. |
| [Sécurité de Zigbee (FR)](https://sti.eduscol.education.fr/sites/eduscol.education.fr.sti/files/ressources/pedagogiques/17042/17042-securite-de-zigbee-ensps.pdf) | French educational resource on Zigbee protocol security analysis. |
| [Analyzing Zigbee Security via SDR](https://bulmathmc.enu.kz/index.php/main/article/view/328) | Research paper on analyzing Zigbee communication security in smart environments using Software Defined Radio. |
...
| [MITRE Caldera for OT](https://github.com/mitre/caldera-ot) | MITRE Caldera OT plugins and capabilities for adversary emulation and red team operations in ICS/OT environments. |
| [Schneider UMAS TALOS Vulnerability](https://vulners.com/talos/TALOS-2018-0745) | Talos vulnerability disclosure for Schneider Electric Modicon M580 UMAS Read Memory Block out-of-bounds read. |
